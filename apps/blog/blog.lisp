...
(define-easy-handler (blog-page
		      ...
		      :uri (define-matching-functions "^/([^/]+)/([^/]+)$" *ninx-blog-host*)
		      :host *ninx-blog-host*) ()
  (trivia:match
...
(define-easy-handler (view-draft
		      :acceptor-names '(ninx::ninx)
		      :uri (define-matching-functions "^/([^/]+)/view-draft/([^/]+)$" *ninx-blog-host*)
		      :host *ninx-blog-host*) ()
  (trivia:match
      (str:split "/" (script-name*))
...
(define-easy-handler (create-blog-post
		      :acceptor-names '(ninx::ninx)
		      :host *ninx-blog-host*
		      :uri (define-matching-functions "^/([^/]+)/create-blog-post$" *ninx-blog-host*)
		      ) ()
...
(define-easy-handler (update-blog-post
		      :acceptor-names '(ninx::ninx)
		      :host *ninx-blog-host*
		      :uri (define-matching-functions "^/([^/]+)/update-blog-post/([^/]+)$" *ninx-blog-host*)) ()
  (if (null (cookie-in "na-cookie"))
      (redirect "/admin/login")
      (trivia:match
	  (str:split "/" (script-name*))
...
(define-easy-handler (save-blog-post
		      ...
		      :host *ninx-blog-host*
		      :uri (define-matching-functions "^/([^/]+)/save-blog-post$" *ninx-blog-host*))
...
(define-easy-handler (edit-blog-post
		      ...
		      :default-request-type :post
		      :host *ninx-blog-host*
		      :uri (define-matching-functions "^/([^/]+)/edit-blog-post/([^/]+)$" *ninx-blog-host*))
    (draft title url author essay)
  (if (null (cookie-in "na-cookie"))
      (redirect "/admin/login")
      (trivia:match
...
(define-easy-handler (save-blog-post-as-draft
		      :acceptor-names '(ninx::ninx)
		      :host *ninx-blog-host*
		      :uri (define-matching-functions "^/([^/]+)/save-blog-post-as-draft/([^/]+)$" *ninx-blog-host*)) ()
  (if (null (cookie-in "na-cookie"))
      (redirect "/admin/login")
      (trivia:match
	  (str:split "/" (script-name*))
...
(define-easy-handler (delete-blog-post
		      :acceptor-names '(ninx::ninx)
		      :host *ninx-blog-host*
		      :uri (define-matching-functions "^/([^/]+)/delete-blog-post/([^/]+)$" *ninx-blog-host*)) ()
  (if (null (cookie-in "na-cookie"))
      (redirect "/admin/login")
      (trivia:match
	  (str:split "/" (script-name*))
...
(define-easy-handler (drafts-page
		      :acceptor-names '(ninx::ninx)
		      :uri (ninx:define-matching-functions "^/([^/]+)/drafts$" *ninx-blog-host*)
		      :host *ninx-blog-host*) ()
  (if (null (cookie-in "na-cookie"))
      (redirect "/admin/login"))
  (trivia:match
...
(define-easy-handler (admin-login
		      :acceptor-names '(ninx::ninx)
		      :uri (define-matching-functions "^/admin/login$" *ninx-blog-host*)
		      :host *ninx-blog-host*) ()
...
(define-easy-handler (process-admin-login
		      :acceptor-names '(ninx::ninx)
		      :uri (define-matching-functions "^/admin/process-login$" *ninx-blog-host*)
		      :default-request-type :post
		      :host *ninx-blog-host*)
    (username password)
...
(define-easy-handler (admin-logout
		      :acceptor-names '(ninx::ninx)
		      :uri (define-matching-functions "^/admin/logout$" *ninx-blog-host*)
		      :host *ninx-blog-host*) ()
...
(define-easy-handler (admin-dashboard
		      :acceptor-names '(ninx::ninx)
		      :host *ninx-blog-host*
		      :uri (define-matching-functions "^/admin$" *ninx-blog-host*)) ()
